...
<div class="progress" role="progressbar" aria-label="Animated striped example" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
    <div class="progress-bar progress-bar-striped bg-success progress-bar-animated" style="width: 16%">1/6 </div>
</div>
    <div class="space"></div>
<!-- Main Container -->
<div class="container">
    ...
    <div class="nav-buttons">
        <button type="button" onclick="location.href='../index.jsp'">이전</button>
